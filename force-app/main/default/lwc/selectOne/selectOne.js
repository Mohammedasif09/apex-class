...
export default class SelectOne extends LightningElement {
    ...
    setQueuePicklistLabels(){
        ...
        if(selectedQueueArr.length < this.maximumLength){
            this.selectedQueues = selectedQueueArr[0];
        }
        else{
            console.log('inside');
            if(selectedQueueArr.length > this.maximumLength){
                ...
                this.selectedQueues = selectedQueueArr[0]+', '+selectedQueueArr[1]+', ( '+String(selectedQueueArr.length - 2)+' More Items. )';
            }
            else{
                this.selectedQueues = selectedQueueArr[0]+', '+selectedQueueArr[1];
            }
        }
        console.log('selectedQueues',this.selectedQueues);
    }
